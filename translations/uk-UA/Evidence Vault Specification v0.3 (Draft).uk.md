...
**Версія:** 0.3 (консенсус Claude + Aiya)  
...
- Grok (xAI) — початковий драфт (v0.1)
- Claude (Anthropic) — доповнення схеми, режими відмов (v0.2)
- ChatGPT/Aiya (OpenAI) — профілі, подієво-тригерний режим, narrative_risk (v0.3)

**Попередні версії:**
- v0.1 — початковий драфт Grok
- v0.2 — огляд Claude (доповнення схеми)
- v0.3 — огляд Aiya (профілі, подієві тригери, narrative_risk)
